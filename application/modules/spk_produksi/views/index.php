...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-warning btn-sm view" href="<?= base_url('/spk_produksi/addHeader/'.$record->id_spkproduksi.'/view') ?>" title="View"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>
						<?php if($ENABLE_MANAGE) : ?>
			<a class="btn btn-primary btn-sm" href="<?= base_url('/spk_produksi/addHeader/'.$record->id_spkproduksi) ?>"  title="Edit"><i class="fa fa-edit"></i></a>
			<?php endif; ?>
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-success btn-sm delete" href="javascript:void(0)" title="Turunkan" data-id_spkproduksi="<?=$record->id_spkproduksi?>"><i class="fa fa-check"></i>
				</a>
			<?php endif; ?>
			</td>
			<?php }else{ ?>
