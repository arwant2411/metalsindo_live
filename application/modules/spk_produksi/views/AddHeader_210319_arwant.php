    ...
    <div class="box-body">
		...
		<div class="form-group row">
			...
			<div class="col-md-8">
					<select id="id_material" name="id_material" class="form-control select" onchange="Caristock()" required>
						...
						<option value="<?= $material->id_category3?>"><?= ucfirst(strtolower($material->nama_category2))?>--<?= ucfirst(strtolower($material->nama))?>-<?= ucfirst(strtolower($material->hardness))?>-<?= ucfirst(strtolower($material->thickness))?></option>
							<?php } ?>
					</select>
			</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control' id='weight' onkeyup required name='weight' readonly >
			</div>
			</div>
		</div>
		<div class="col-sm-6">
		<div class="form-group row">
			...
			<div class="col-md-8" id="slot_density">
				<input type='number' class='form-control' id='density' onkeyup required name='density' readonly >
			</div>
		</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control' id='thickness' onkeyup required name='thickness' readonly >
			</div>
			</div>
		</div>
		<div class="col-sm-6">
		<div class="form-group row" id="slot_customer">
			...
			<div class="col-md-8" id="slot_panjang">
				<input type='number' class='form-control' id='panjang' onkeyup required name='panjang' readonly >
			</div>
		</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			...
			<div class="col-md-8" id="slot_width">
				<input type='number' class='form-control' id='width' onkeyup required name='width' readonly >
			</div>
			</div>
		</div>
		<div class="col-sm-6" hidden>
			...
			<div class="col-md-8" id="hiden_slot">
				<input type='text' class='form-control' id='lotno' onkeyup required name='lotno' readonly >
				<input type='text' class='form-control' id='nama_material' onkeyup required name='nama_material' readonly >
			</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control' id='lpegangan' onkeyup required name='lpegangan' readonly >
			</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control' id='qcoil' onkeyup required name='qcoil' readonly >
			</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control' id='jpisau' onkeyup required name='jpisau' readonly >
			</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div hidden ><input type='number'  class='form-control' id='used' onkeyup required name='used' readonly ></div>
				<input type='number' class='form-control' id='sisa' onkeyup required name='sisa' readonly >
			</div>
			</div>
		</div>
		</div>
