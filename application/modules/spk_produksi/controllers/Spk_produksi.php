...
function GetSpk()
    {
		...
		echo	"</select>
			...
			<th>
				<input type='hidden' class='form-control' value='$thickness' readonly id='used_thickness_$loop' required name='dt[$loop][thickness]'>
				<input type='text' class='form-control' value='$nama_material' readonly id='used_nmmaterial_$loop' required name='dt[$loop][nmmaterial]'>
				<input type='hidden' class='form-control' id='used_width_$loop' onkeyup='HitungTotalCoil($loop)' required name='dt[$loop][width]'>
			</th>
			<th id='weight_$loop'><input type='text' class='form-control' id='used_weight_$loop' required name='dt[$loop][weight]'></th>
			<th id='width2_$loop'><input type='text' class='form-control' id='used_weight2_$loop' required name='dt[$loop][weight2]' readonly></th>
			...
			<th id='twidth_$loop'><input type='text' class='form-control' id='used_totalwidth_$loop' required name='dt[$loop][totalwidth]' readonly></th>
			<th id='delivery_$loop'><input type='date' class='form-control' id='used_delivery_$loop' required name='dt[$loop][delivery]'></th>
			<th align='center'>
				<input type='checkbox' class='chk_personal' id='ch_$loop' name='dt[$loop][id]' value='$loop'>
			</th>
			<th align='center'>
...
function CariW1material()
    {
		...
		echo "<input type='text' class='form-control change_weightc autoNumeric' $readonly  value='$id_customerr' id='used_weight_$loop' required name='dt[$loop][weight]'>";
	}
function CariW2material()
    {
		...
		echo "<input type='text' class='form-control' value='".number_format($hasil,2)."' id='used_weight2_$loop' required name='dt[$loop][weight2]' readonly>";
	}
function CariTW2material()
    {
		...
		echo "<input type='text' class='form-control'  value='".number_format($total_kg,2)."'  id='used_totalwidth_$loop' required name='dt[$loop][totalwidth]' readonly>";
	}
...
function CariQrollmaterial()
    {
        $loop=$_GET['id'];
		echo "<input type='text' class='form-control change_weightc autoNumeric'  value='' id='used_qtycoil_$loop' required name='dt[$loop][qtycoil]'>";
	}
