...
<div class="row">
		...
		echo "
			...
			<th><input type='date' class='form-control'   			value='$val2x->delivery' 			readonly id='used_delivery_$loop' required name='dt[$loop][delivery]'></th>				
                ...
                // $no = 0;
				// $process = $this->db->query("SELECT * FROM dt_spk_produksi_lph WHERE id_dt_spkproduksi='".$val2x->id_dt_spkproduksi."'")->result();
    ...
    // <td>
    // <input type='Time' name='dt[".$id."][detail][".$no."][finish]' value='".$val2Dx->finish."' class='form-control input-md' placeholder='berat'   id='finish_".$id."_".$no."' >
    // </td>
	// <td align='left' colspan='2'>Total</td>
    // <td align='left' colspan='2'>
    // <input type='number' name='dt[".$id."][detail][".$no."][total]' value='".$val2Dx->total."' class='form-control input-md formsubagain' placeholder='Total Waktu'   id='total_".$id."_".$no."' >
    // </td>
	// <td align='center'>
