...
<body>
    ...
    <table class='gridtable' width='100%'  align="left" border='1' cellpadding='2'>
        ...
        ?>
            <tr>
                <td><?=$loop;?></td>
                <td><?=strtoupper($no_suratx($dt_spk['no_surat']));?></td>
                <td><?=$dt_spk['namacustomer'];?></td>
                <td><?=$dt_spk['nmmaterial'];?></td>
                <td align='right'><?=number_format($dt_spk['weight'],2);?></td>
                <td align='right'><?=number_format($dt_spk['width'],2);?></td>
                <td align='right'><?=number_format($dt_spk['qtycoil'],2);?></td>
                <td align='right'><?=number_format($dt_spk['totalwidth'],2);?></td>
                <td align='right'><?=date('d F Y', strtotime($dt_spk['delivery']));?></td>
            </tr>
        <?php
        }
        ?>
