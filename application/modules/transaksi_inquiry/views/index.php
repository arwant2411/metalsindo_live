...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<td><?= $record->tgl_inquiry ?></td>
			<td style="padding-left:20px">
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>

			<?php if($ENABLE_DELETE) : ?>
				<a class="btn btn-primary btn-sm" href="<?= base_url('/transaksi_inquiry/detail/'.$record->no_inquiry) ?>" title="Detail" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-table"></i>
				</a>
			<?php endif; ?>
			</td>
...
<script type="text/javascript">
	...
	$(document).on('click', '.edit', function(e){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'transaksi_inquiry/editBentuk/'+id,
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'transaksi_inquiry/ViewCrcl/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
		...
		$.ajax({
			type:'POST',
			url:siteurl+'transaksi_inquiry/addInquiry',
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
