										...
										<div class="form-group row">
											...
											<div class="col-md-6">
											  <select id="id_prov" name="id_prov" class="form-control select" onchange="get_kota()" required>
												...
												$select = $sup->id_prov == $prof->id_prov ? 'selected' : '';
												?>
												<option value="<?= $prof->id_prov?>" <?= $select ?>><?= $prof->nama?></option>
												<?php } ?>
											  </select>
											</div>
										</div>
			...
			echo"<td align='left'><input type='text' class='form-control input-sm' name='data1[".$loop."][position_pic]' value='$pic->position_pic' d='data1_".$loop."_position_pic' label='FALSE' div='FALSE'></td>";
						...
						<div class="col-sm-6">
							...
							<div class="col-sm-6">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="npwp" required name="npwp" value='<?= $sup->npwp ?>' placeholder="Nomor NPWP">
									    </div>
										</div>
										<div class="form-group row">
										<div class="col-md-6">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="npwp_name" required name="npwp_name" value='<?= $sup->npwp_name ?>' placeholder="Nama NPWP">
									    </div>
										</div>
										<div class="form-group row">
										<div class="col-md-6">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="npwp_address" required name="npwp_address" value='<?= $sup->npwp_address ?>' placeholder="Alamat NPWP">
									    </div>
										</div>
							</div>
