...
{
    //Permission
    protected $viewPermission 	= 'Master_suplier.View';
    protected $addPermission  	= 'Master_suplier.Add';
    protected $managePermission = 'Master_suplier.Manage';
    protected $deletePermission = 'Master_suplier.Delete';
