...
class Material_planing extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Material_planing/Inventory_4_model',
	...
	public function EditHeader()
    {
		...
		$stok_fg 	= $this->db->query("SELECT * FROM stock_material WHERE id_category3 = '$id_material' AND width = '$width' AND id_gudang='3' ")->result();
		$stok_book 	= $this->db->query("SELECT * FROM stock_material WHERE id_category3 = '$id_material' AND width = '$width' AND id_gudang='3' ")->result();
