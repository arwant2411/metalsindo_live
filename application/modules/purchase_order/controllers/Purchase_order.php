...
class Purchase_order extends Admin_Controller
{
    ...
    public function index()
    {
       $this->auth->restrict($this->viewPermission);
        ...
        $data = $this->db->query("SELECT a.*, b.name_suplier as namesup FROM tr_purchase_order as a INNER JOIN master_supplier as b on a.id_suplier = b.id_suplier")->result();
...
function AddMaterial()
    {
		...
		<th								style='font-size:90%'><input style='font-size:90%' class='form-control input-md bilangan-desimal'	readonly		class='form-control' id='dt_hargasatuan_".$loop."' data-decimal='.' data-thousand='' data-allow-zero='' 	required name='dt[".$loop."][hargasatuan]' onblur='HitungUP(".$loop.")'></th>
		
		<th								style='font-size:90%'><input style='font-size:90%' type='number' 			class='form-control' id='dt_diskon_".$loop."' 		required name='dt[".$loop."][diskon]' onkeyup='HitungUP(".$loop.")'></th>
		
		<th								style='font-size:90%'><input style='font-size:90%' type='number' 			class='form-control' id='dt_pajak_".$loop."' 		required name='dt[".$loop."][pajak]' onkeyup='HitungUP(".$loop.")'></th>
		...
		<th id='width_".$loop."'		hidden><select  type='number' style='font-size:90%'	class='form-control' id='dt_width_".$loop."' 		required name='dt[".$loop."][width]' onkeyup='HitungHarga(".$loop.")' ></th>
		<th id='qty_".$loop."'			hidden style='font-size:90%'><input style='font-size:90%' type='number' 			class='form-control' id='dt_qty_".$loop."' 			required name='dt[".$loop."][qty]' onkeyup='HitungUP(".$loop.")' ></th>
		<th 							style='font-size:90%' ><select		style='font-size:90%'		disabled		class='form-control' id='dt_ratelme_".$loop."' 		required name='dt[".$loop."][ratelme]' onchange='CariPrice(".$loop.")'>
		<option value=''>-Pilih-</option>
		<option value='Hari Ini'>Hari ini</option>
		<option value='H-10'>H-10</option>
		<option value='H-30'>H-30</option>
		</select></th>
		<th id='alloyprice_".$loop."'	style='font-size:90%'><input  type='text' 	style='font-size:90%' disabled class='form-control input-md bilangan-desimal' id='dt_alloyprice_".$loop."' 	required data-decimal='.' data-thousand='' data-precision='0' data-allow-zero='' name='dt[".$loop."][alloyprice]' onkeyup='HitungUP(".$loop.")' ></th>
		<th 							style='font-size:90%'><input  type='text' 	style='font-size:90%' disabled	class='form-control input-md bilangan-desimal' id='dt_fabcost_".$loop."' 		required data-decimal='.' data-thousand='' data-precision='0' data-allow-zero='' name='dt[".$loop."][fabcost]' onkeyup='HitungUP(".$loop.")' ></th>
		<th	id='panjang_".$loop."'		hidden><input  type='number' style='font-size:90%'	class='form-control' id='dt_panjang_".$loop."' 		required name='dt[".$loop."][panjang]' onkeyup='HitungHarga(".$loop.")'></th>
		<th	id='lebar_".$loop."'		hidden><input  type='number' style='font-size:90%'	class='form-control' id='dt_lebar_".$loop."' 		required name='dt[".$loop."][lebar]' ></th>
		<th								style='font-size:90%'><input style='font-size:90%' class='form-control input-md bilangan-desimal'			class='form-control' id='dt_hargasatuan_".$loop."' 	required data-decimal='.' data-thousand='' data-precision='0' data-allow-zero='' name='dt[".$loop."][hargasatuan]' onkeyup='HitungUP(".$loop.")'></th>
		<th								style='font-size:90%'><input style='font-size:90%' type='number' 			class='form-control' id='dt_diskon_".$loop."' 		required name='dt[".$loop."][diskon]' onkeyup='HitungUP(".$loop.")'></th>
		<th								style='font-size:90%'><input style='font-size:90%' type='number' 			class='form-control' id='dt_pajak_".$loop."' 		required name='dt[".$loop."][pajak]' onkeyup='HitungUP(".$loop.")'></th>
		<th id='jumlahharga_".$loop."'	style='font-size:90%'><input style='font-size:90%' readonly type='text' 	class='form-control' id='dt_jumlahharga_".$loop."' 	required name='dt[".$loop."][jumlahharga]' ></th>
		<th								style='font-size:90%'><input style='font-size:90%' type='text' 			class='form-control' id='dt_note_".$loop."' 		required name='dt[".$loop."][note]' ></th>
...
function LockMatrial()
    {
		...
		<td hidden><input		readonly  	type='number' 	value='".$width."'		class='form-control' id='dt_width_".$loop."' 			required name='dt[".$loop."][width]'  ></td>
		...
		<td	><input		readonly	type='text' 	value='".$pajak."'				class='form-control' id='dt_pajak_".$loop."' 		required name='dt[".$loop."][pajak]' ></td>
...
function HitungUP()
    {
        $alloyprice=str_replace(",","",$_GET['alloyprice']);
		 ...
		 $total = number_format(round(($alloyprice+$fabcost)/1000,3),2,".",",");
		  ...
		  $total = number_format($hargasatuan,2,".",",");
		  }
		echo "".$total."";
	}
function Hitjumlah()
...
function FormInputKurs() 
	...
	$k30 =  $nomkurs30;
		...
		<div class='form-group row'>
			...
			<div class='col-md-8'>
				<input type='text' class='form-control' value='".number_format($nomkurs30,2)."' id='nominal_kurs'  required name='nominal_kurs'  placeholder='Nominal Kurs'>
			</div>
		</div>
		";}else{
		echo "
