...
<br>
		<table id="tables" border="0" width='100%'  align="center" cellpadding="2" cellspacing="0">
			...
			<td align='center'>".number_format($detail->hargasatuan,2)."</td>
			<td align='center'>".number_format($detail->jumlahharga)."<br><br>".$header->cif ."</td>
			...
			<td align='center'>".number_format($detail->totalwidth)."</td>
			<td align='center'>".number_format($detail->hargasatuan)."</td>
			<td align='center'>".number_format($detail->jumlahharga)."<br><br>".$header->cif ."</td>
			<td align='center'>".$detail->description."</td>
			</tr>";
			}
			...
			<td align="center"><?= number_format($detailsum[0]->sumhargasatuan) ?></td>
