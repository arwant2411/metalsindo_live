<?php
    ...
    $ENABLE_VIEW    = has_permission('PO.View');
...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View" data-no_po="<?=$record->no_po?>"><i class="fa fa-eye"></i>
				</a>
				<a class="btn btn-success btn-sm" href="<?= base_url('/purchase_order/PrintH/'.$record->no_po) ?>" target="_blank"title="Print" ><i class="fa fa-print"></i></a>
			<?php endif; ?>
			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-success btn-sm" href="<?= base_url('/purchase_order/edit/'.$record->no_po) ?>" title="Edit" ><i class="fa fa-edit"></i></a>
			<?php endif; ?>
			<?php if($ENABLE_MANAGE) : ?>
