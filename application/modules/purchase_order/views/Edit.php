					...
					<select id="id_suplier" name="id_suplier" class='form-control input-md chosen-select'required>
						<option value="">--Pilih--</option>
							...
							$selected = ($supplier->id_suplier == $head->id_suplier)?'selected':'';	
								?> 
						<option value="<?= $supplier->id_suplier?>" <?=$selected;?>><?= ucfirst(strtolower($supplier->name_suplier))?></option>
							<?php } ?>
					</select>
				</div>
			</div>
...
<tr class='bg-blue'>
			...
			<th width='6%'	style="font-size:90%">Qty (Unit)</th>
			...
			$hargasatuan=number_format($detail->hargasatuan);
		...
		<td hidden><input style='font-size:90%' readonly 	type='text' 	alue='".$detail->idmaterial."'		class='form-control' id='dt_idmaterial_".$loop."' 	required name='dt[".$loop."][idmaterial]' ></td>
		...
		<td hidden><input	style='font-size:90%'	readonly  	type='number' 	value='".$detail->width."'			class='form-control' id='dt_width_".$loop."' 			required name='dt[".$loop."][width]'  ></td>
		<td ><input	style='font-size:90%'	readonly  	type='number' 	value='".$detail->qty."'			class='form-control' id='dt_qty_".$loop."' 			required name='dt[".$loop."][qty]'  ></td>
		...
		<td hidden><input	style='font-size:90%'	readonly  	type='number' 	value='".$detail->totalwidth."'			class='form-control' id='dt_totalwidth_".$loop."' 			required name='dt[".$loop."][totalwidth]'  ></td>
		...
		<td	><input	style='font-size:90%'	readonly 	type='number' 	value='".$detail->diskon."'			class='form-control' id='dt_diskon_".$loop."' 		required name='dt[".$loop."][diskon]' ></td>
		<td	><input	style='font-size:90%'	readonly	type='number' 	value='".$detail->pajak."'			class='form-control' id='dt_pajak_".$loop."' 		required name='dt[".$loop."][pajak]' ></td>
