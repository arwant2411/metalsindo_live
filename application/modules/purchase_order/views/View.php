...
.modal-dialog{
 ...
 <div class="box box-primary">
	...
	<tr class='bg-blue'>
			...
			<td hidden><input readonly 	type='text' 	value='".$detail->idpr."'		class='form-control' id='dt_idpr_".$loop."' 	required name='dt[".$loop."][idpr]' ></td>
		<td hidden><input readonly 	type='text' 	value='".$detail->idmaterial."'		class='form-control' id='dt_idmaterial_".$loop."' 	required name='dt[".$loop."][idmaterial]' ></td>
		<td ><input		readonly  	type='text' 	value='".$detail->namamaterial."'	class='form-control' id='dt_namamaterial_".$loop."' required name='dt[".$loop."][namamaterial]' ></td>
		<td ><input		readonly  	type='text' 	value='".$detail->description."'	class='form-control' id='dt_description_".$loop."' 	required name='dt[".$loop."][description]' ></td>
		<td hidden ><input		readonly  	type='number' 	value='".$detail->width."'			class='form-control' id='dt_width_".$loop."' 			required name='dt[".$loop."][width]'  ></td>
		<td hidden ><input		readonly  	type='number' 	value='".$detail->qty."'			class='form-control' id='dt_qty_".$loop."' 			required name='dt[".$loop."][qty]'  ></td>
		<td ><input		readonly  	type='number' 	value='".$detail->totalwidth."'			class='form-control' id='dt_totalwidth_".$loop."' 			required name='dt[".$loop."][totalwidth]'  ></td>
		<td	><input		readonly  	type='number' 	value='".$detail->hargasatuan."'	class='form-control' id='dt_hargasatuan_".$loop."' 	required name='dt[".$loop."][hargasatuan]' ></td>
		<td	><input		readonly 	type='number' 	value='".$detail->diskon."'			class='form-control' id='dt_diskon_".$loop."' 		required name='dt[".$loop."][diskon]' ></td>
		<td	><input		readonly	type='number' 	value='".$detail->pajak."'			class='form-control' id='dt_pajak_".$loop."' 		required name='dt[".$loop."][pajak]' ></td>
		<td ><input		readonly 	type='number' 	value='".$detail->jumlahharga."'	class='form-control' id='dt_jumlahharga_".$loop."' 	required name='dt[".$loop."][jumlahharga]' ></td>
		<td	><input		readonly  	type='text' 	value='".$detail->note."'			class='form-control' id='dt_note_".$loop."' 		required name='dt[".$loop."][note]' ></td>
			</tr>
			";
			}
			?>
