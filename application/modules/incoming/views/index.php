...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View" data-id_data="<?=$record->id_data?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>
			<?php if($ENABLE_MANAGE) : ?>
			<a class="btn btn-primary btn-sm" href="<?= base_url('/incoming/print_incoming_fix/'.$record->id_data) ?>" title="Print" ><i class="fa fa-print"></i></a>
			<?php endif; ?>
			</td>
