...
class Incoming extends Admin_Controller
{
	...
	public function TambahData(){
		...
		<th				hidden	><input  type='date' 		value='".$tanggal."'				class='form-control' id='dt_tanggal_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][tanggal]' ></th>
		<th				hidden  ><input  type='text' 		value='".$no_po."'		            class='form-control' id='no_po".$id."_".$no."' 			        required name='dt[".$id."][detail][".$no."][no_po]' 	readonly></th>
		<th				        ><input  type='text' 		value='".$no_surat."'		        class='form-control' id='no_surat".$id."_".$no."' 			        required name='dt[".$id."][detail][".$no."][no_surat]' 	readonly></th>
		<th				hidden  ><input  type='text' 		value='".$material->id_dt_po."'		class='form-control' id='dt_iddtpo_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][iddtpo]' 	readonly></th>
		<th				hidden	><input  type='text' 		value='".$material->idmaterial."'	class='form-control' id='dt_idmaterial_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][id_material]' 	readonly></th>
		<th						><input  type='text' 		value='".$material->namamaterial."'	class='form-control' id='dt_namamaterial_".$id."_".$no."' 	required name='dt[".$id."][detail][".$no."][nama_material]' readonly></th>
		<th				hidden	><input  type='text' 		value='".$material->panjang."'		class='form-control' id='dt_length_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][length]' 		readonly></th>
		<th				hidden	><input  type='number' 		value='".$material->lebar."'		class='form-control' id='dt_width_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][width]'  		readonly></th>
		<th						><input  type='number' 		value='".$material->width."'		class='form-control text-right' id='dt_weight_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][weight]' 		readonly></th>
		<th						><input  type='number' 		value='".$material->totalwidth."'	class='form-control text-right' id='dt_qtyorder_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyorder]'     readonly></th>
		<th						><input  type='number' 											class='form-control' id='dt_qtyrecive_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyrecive]' 	></th>
		<th						><input  type='text' 											class='form-control' id='dt_widthrecive".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][widthrecive]' 		></th>
		<th						><input  type='text' 											class='form-control' id='dt_lotno_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][loto]' 		></th>
		
		
		<th style='font-size:90%'><select style='font-size:90%' class='form-control chosen-select' id='dt_gudang_".$id."_".$no."'
		...
		<td align='center'>
			...
			<button type='button' class='btn btn-sm btn-primary repeatSubPart' data-no1='".$id."' data-no2='".$no."' data-id='".$material->id_dt_po."' title='Repeat Part'><i class='fa fa-retweet'></i></button>
		</td>
		</tr>"; 
		}
	...
	public function TambahDataRepeat(){
		...
		<th				hidden	><input  type='text' 		value='".$material->panjang."'		class='form-control' id='dt_length_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][length]' 		readonly></th>
		<th				hidden	><input  type='number' 		value='".$material->lebar."'		class='form-control' id='dt_width_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][width]'  		readonly></th>
		<th				hidden	><input  type='number' 		value='".$material->width."'		class='form-control' id='dt_weight_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][weight]' 		readonly></th>
		<th						><input  type='number' 		value='".$material->totalwidth."'class='form-control' id='dt_qtyorder_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyorder]'     readonly></th>
		<th						><input  type='number' 											class='form-control' id='dt_qtyrecive_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyrecive]' 	></th>
		<th						><input  type='text' 											class='form-control' id='dt_widthrecive".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][widthrecive]' 		></th>
...
function FormPo()
    {
		...
		$listpo = $this->db->query("SELECT 
									...
									WHERE 
										a.id_suplier='".$id_suplier."' AND b.close_po = 'N' GROUP BY a.no_po ")->result();
	...
	<div id='po_".$id."'>
		...
		<div class='form-group row' >
			...
			<th hidden width='7%'>Length</th>
			<th width='7%'>Width</th>
			<th hidden width='7%'>Weight Per Coil</th>
			<th width='7%'>Qty Order (Kg)</th>
			<th width='7%'>Coil</th>
			<th width='7%'>Weight Receive </th>
...
public function SaveNew(){
    ...
    foreach($Detail AS $val => $valx){
      ...
      foreach($valx['detail'] AS $val2 => $valx2){
			...
			$ArrDetail2[$val2.$val]['qty_order'] 			= $valx2['qtyorder'];
			$ArrDetail2[$val2.$val]['qty_recive'] 			= $valx2['qtyrecive'];
			$ArrDetail2[$val2.$val]['tgl_datang'] 			= $post['tanggal'];
			$ArrDetail2[$val2.$val]['lotno'] 				= $valx2['loto'];
			$ArrDetail2[$val2.$val]['width_recive'] 		= $valx2['widthrecive'];
	       ...
	       foreach($valx['detail'] AS $val2 => $valx2){
			...
			$ArrStok[$val2.$val]['weight'] 				= $valx2['qtyrecive'];
			$ArrStok[$val2.$val]['totalweight'] 		= $valx2['qtyrecive'];
			$ArrStok[$val2.$val]['aktif'] 				= 'Y';
			$ArrStok[$val2.$val]['id_gudang'] 			= $valx2['gudang'];
			$ArrStok[$val2.$val]['width'] 		        = $valx2['widthrecive'];
	...
	public function PrintH(){
	 ...
	 function print_incoming_fix() {
		...
		// $data['detail']  = $this->db->query("SELECT * FROM dt_trans_po WHERE no_po = '".$id."' ")->result();
		// $data['detailsum'] = $this->db->query("SELECT SUM(width) FROM dt_trans_po WHERE no_po = '".$id."' ")->result();
		$head = $this->db->query("SELECT a.*, b.nama_gudang as namagudang FROM tr_incoming as a INNER JOIN ms_gudang as b ON a.id_gudang = b.id_gudang WHERE a.id_data='".$id."' ")->row();
        ...
        $header = '
		  ...
		  <tr><b>
				 ...
				 <td width="1%" style="font-size:8pt !important;vertical-align:top"><b>:</b></td>
				 <td width="35%" style="font-size:8pt !important;vertical-align:top"><b>' . @$head->tanggal . '</b></td>
