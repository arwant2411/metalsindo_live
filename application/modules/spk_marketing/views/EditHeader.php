 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		echo "
			...
			<th id='total_harga_$loop'><div hidden><input type='text' class='form-control' value='$dt->harga_penawaran' readonly id='dp_tharga_$id' required name='dp[$id][tharga]'></div>
			<input type='text' class='form-control' value='".$thg."' readonly></th>
			<th><input type='date' class='form-control'   value='$dt->delivery' id='dp_ddate_$loop' data-role='qtip' onkeyup='return required name='dp[$loop][ddate]'></th><th><select id='dp_crcl_$loop' name='dp[$loop][crcl]' class='form-control select' required>
						<option value=''>--Pilih--</option>";
