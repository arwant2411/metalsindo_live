  ...
  <div class="tab-content">
    ...
    <div class="tab-pane " id="update">
      ...
      <div class="box box-primary">
			...
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-success btn-sm add_local" href="javascript:void(0)" title="Upgrade"><i class="fa fa-plus">&nbsp;</i>Update Profit</a>
			<?php endif; ?>
...
<script type="text/javascript">
	...
	$(document).on('click', '.add_local', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'master_profit_material/EditHarga',
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
