...
?>
 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		$suppliers = $this->db->query("SELECT a.*, b.name_suplier as supname FROM child_inven_suplier as a INNER JOIN master_supplier as b on a.id_suplier = b.id_suplier WHERE a.id_category3 = '$detail->idmaterial' ")->result();
		echo "
		<tr id='tr_$loop'>
		...
		echo"<option value='$material->id_category3' $selected>$material->bentuk $material->alloy $material->nama $material->hardness $thickness</option>";
		...
		echo"<option value='$material->id_category3' $selected>$material->bentuk $material->alloy $material->nama $material->hardness $thickness x $thickness</option>";
		...
		$thickness2 = $dimensi[0]->nilai_dimensi;
		echo"<option value='$material->id_category3' $selected>$material->bentuk $material->alloy $material->nama $material->hardness $thickness $thickness2</option>";
		...
		<td><input type='text' class='form-control autoNumeric text-right' value='".$detail->odameter ."' id='dt_odameter_$loop' 			required name='dt[$loop][odameter]' 	></td>
		...
		<td hidden><input type='number' class='form-control' id='dt_length_$loop' value='".$detail->length ."'	required name='dt[$loop][length]' ></td>
