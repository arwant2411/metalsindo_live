...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<td style="padding-left:20px">
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View" data-id_spkmarketing="<?=$record->id_delivery_order?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm" href="<?= base_url('/delivery_order/PrintHeader/'.$record->id_delivery_order) ?>" target="_blank" title="Detail"><i class="fa fa-print"></i>
				</a>
			<?php endif; ?>

			<?php if($ENABLE_MANAGE) : ?>
			<a class="btn btn-primary btn-sm" href="<?= base_url('/delivery_order/editHeader/'.$record->id_delivery_order) ?>"  title="Edit"><i class="fa fa-edit">&nbsp;</i></i></a>
			<?php endif; ?>
			<?php if($ENABLE_VIEW) : ?>
				<!--<a class="btn btn-primary btn-sm delete" href="javascript:void(0)" title="Approve" data-id_spkmarketing="<?=$record->id_spkmarketing?>"><i class="fa fa-check"></i>
				</a>-->
